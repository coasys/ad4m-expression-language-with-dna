...
// All the functions below can be called from with the js code
// This functions use hdk::prelude::* to interact with the Holochain conductor
// The #[hdk_extern] attribute is used to expose the function to the Holochain conductor
// 
// These functions are used to store and retrieve file expressions and file chunks
